...
function RegisterPage()
    {
        ...
        return(
            <Fragment>
                <Navbar/>
                <RegisterButton isEnabledEmail={emailValidity} isEnabledPassword={passwordValidity} isEnabledPasswordConfirm={confirmPasswordValidity}></RegisterButton>
                <ConfigProvider
                    theme={{
                        components: {
                ...
                <div className="emailTitleRegister">Email:</div>
                ...
                <div className="newPasswordTitle">Password:</div>
